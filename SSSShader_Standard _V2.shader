Shader "Skin/Skin Standard Shader V2 (WIP)" {
	Properties {
        ...
        _DetailNormalMapIntensity ("Detail Normal Map Intensity Diffuse", Range(-2,2)) = 1
        _DetailNormalMapIntensitySpec ("Detail Normal Map Intensity Specular", Range(-2,2)) = 1
	...
	SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            o.Normal = normalize(n + nD);
                ...
                //o.Occlusion = tex2D (_S_AO_SSS_Tex, IN.uv_MainTex).g * _AOStrength;
                ...
                o.Occlusion = lerp(1, tex2D (_AOTex, IN.uv_MainTex).g, _AOStrength);
            #endif
